...
INSERT INTO _business_establishment(name, official_record) VALUES ('Carrefour Dutra','45.543.915/0036-01');
INSERT INTO _business_establishment(name, official_record) VALUES ('Shibata Jardim Oriente','29.877.151/0001-04');
...
INSERT INTO _shop_list_item(shop_list_id, product_id, required_quantity, buyed_quantity, price, business_establishment_id, created_at, updated_at) VALUES ((SELECT id FROM _shop_list WHERE name = 'First List'), (SELECT id FROM _product WHERE barcode = '7896051111016'), '2.0', '2.0', '5.89', (SELECT id FROM _business_establishment WHERE name = 'Carrefour Dutra'), now(), now());
INSERT INTO _shop_list_item(shop_list_id, product_id, required_quantity, buyed_quantity, price, business_establishment_id, created_at, updated_at) VALUES ((SELECT id FROM _shop_list WHERE name = 'First List'), (SELECT id FROM _product WHERE barcode = '7896034610017'), '1.0', '3.0', '4.99', (SELECT id FROM _business_establishment WHERE name = 'Carrefour Dutra'), now(), now());
INSERT INTO _shop_list_item(shop_list_id, product_id, required_quantity, buyed_quantity, price, business_establishment_id, created_at, updated_at) VALUES ((SELECT id FROM _shop_list WHERE name = 'First List'), (SELECT id FROM _product WHERE barcode = '7896029000441'), '5.0', '5.0', '3.29', (SELECT id FROM _business_establishment WHERE name = 'Shibata Jardim Oriente'), now(), now());
...
INSERT INTO _shop_list_item(shop_list_id, product_id, required_quantity, buyed_quantity, price, business_establishment_id, created_at, updated_at) VALUES ((SELECT id FROM _shop_list WHERE name = 'Second List'), (SELECT id FROM _product WHERE barcode = '7896029017678'), '3.0', '2.0', '3.89', (SELECT id FROM _business_establishment WHERE name = 'Shibata Jardim Oriente'), now(), now());
INSERT INTO _shop_list_item(shop_list_id, product_id, required_quantity, buyed_quantity, price, business_establishment_id, created_at, updated_at) VALUES ((SELECT id FROM _shop_list WHERE name = 'Second List'), (SELECT id FROM _product WHERE barcode = '7896029028391'), '1.0', '1.0', '8.99', (SELECT id FROM _business_establishment WHERE name = 'Shibata Jardim Oriente'), now(), now());
INSERT INTO _shop_list_item(shop_list_id, product_id, required_quantity, buyed_quantity, price, business_establishment_id, created_at, updated_at) VALUES ((SELECT id FROM _shop_list WHERE name = 'Second List'), (SELECT id FROM _product WHERE barcode = '7898960782356'), '1.0', null, '45.59', (SELECT id FROM _business_establishment WHERE name = 'Shibata Jardim Oriente'), now(), now());
